...
<div class="home">
  <div class="col-topbar nav-mobile hide-desktop">
    <div class="topnav">
     ...
     <span class="topDetails">Blood Bank Information</span> 
      </a>
    </div>
...
<div class="content">
  ...
  <section>
    <div class="col-body">
      <div class="col-table hide-app">
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
          <?php
	$sel=mysqli_query($conn,"select * FROM bloodbanks");
    ...
    <?php
	$sel=mysqli_query($conn,"select * FROM bloodbank");
      ...
      <div class="modal-icon">
        <a href="#" id="myBtn" style="width:100%;display:flex">
          ...
          <div class="message-body-notification camp-title" >
            ...
            <p style="margin-top: -5px;"><?= $row['country'];?>, <?= $row['region'];?>, <?= $row['district'];?> <?= $row['plotNo'];?></p>
          </div>    
          </div>
