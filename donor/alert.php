  ...
  <section >
    <div class="col-topbar hide-app">
      <div class="topnav">
       ...
       <span class="topDetails">Alert</span> 
        </a>
      </div>
    ...
    <div class="col-body">
      <div class="col-table">
        <div class="container container-form">
          <form action="../include/newAlertDonor.php" id="form">
              <div class="column" style="width: 100%;">            
                 
                  <div class="field email">
                      <label for="Email_">Alert Type</label><br>
                      <select name="alertType" id="select" required>
                    <option value='Blood Shortage'>Blood Shortage</option>
                    <option value='Selling Of Blood'>Selling Of Blood</option>
                    <option value='Others'>Others</option>
                    </select> 
                  </div>
                  <div class="field email">
                      <label for="Email_">Compose Message</label><br>
                     <textarea name="explanation" placeholder="Type here your message..."></textarea>
                  </div>
              </div>
