...
<div class="home">
  <div class="col-topbar nav-mobile hide-desktop">
    <div class="topnav">
     ...
     <span class="topDetails">Appointment Information</span> 
      </a>
    </div>
...
<div class="content">
  ...
  <section>
	...
	$sel=mysqli_query($conn,"select * FROM appointment INNER JOIN bloodbanks ON bloodbanks.BID = appointment.bloodbank");
  ...
  while($row=mysqli_fetch_assoc($sel))
  
	{
      ...
      <div class="modal-icon">
        <a href="#" id="myBtn" style="width:100%;display:flex">
          <div class="icon-details" style="width:90%;">
           <div class="icon">
          ...
          <div class="message-body-notification camp-title" >
            <div class="head-divide">
              <div class="dive-one" style="width:100%;text-align:left">
                <h5><?= $row['bloodbanks'];?> </h5>
              </div>
            </div>
            
            <p style="margin-top: -5px;"><?= $row['date'];?> <?= $row['time'];?></p>
          </div>    
          </div>
          <div class="icon-arrow" style="padding-top:10px">
          <svg fill="#888"  version="1.1" id="XMLID_287_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-7.44 -7.44 38.88 38.88" xml:space="preserve" stroke="#888"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="next"> <g> <polygon points="6.8,23.7 5.4,22.3 15.7,12 5.4,1.7 6.8,0.3 18.5,12 "></polygon> </g> </g> </g></svg>
          </div>
          </a> 
      </div>
      <?php
