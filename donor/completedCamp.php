...
<div class="home">
  <div class="col-topbar nav-mobile hide-desktop">
    <div class="topnav">
      <a href="camp.php" class="topAction-mobile">
     ...
     <span class="topDetails">Completed Campaigns</span> 
      </a>
    </div>
...
<div class="content">
  <section  class="show-tab hide-nav">
    <div class="col-topbar ">
      <div class="topnav">
        <a href="camp.php" class="show-tab topAction" style="margin-top: -5px;">
  ...
  <section>
    <div class="col-body">
      ...
      include('../include/dbconfig.php');
       $sel=mysqli_query($conn,"select * from camps WHERE endingDate < CURDATE()");
