...
<div class="home">
  <div class="col-topbar nav-mobile hide-desktop">
    <div class="topnav">
     ...
     <span class="topDetails">URCS Information</span> 
      </a>
    </div>
    ...
    <div class="col-body">
      <div class="col-table hide-app">
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
          <?php
	$sel=mysqli_query($conn,"select * FROM urs INNER JOIN users ON users.userID = urs.URSID");
