  ...
  <section>
    <div class="col-body">
      ...
      <div class="head-title">
          ...
          <?php
    $sel = mysqli_query($conn, "SELECT * FROM bloodGroup LIMIT 4");

    $counter = 0; // Counter variable to limit the loop to the first four rows
    while ($row = mysqli_fetch_assoc($sel)) {
        $bloodID = $row['bloodID'];
        $iconImage = $row['bloodGroupImage'];
        ...
        if (!empty($iconImage)) {
            ...
            $imageUrl = "../img/menu-icon/default.png";
        }
?>
        <div class="col-quick-action-details">
            <a href="donor.php?id=<?php echo $id ?> & bloodID=<?php echo $bloodID ?>">
...
?>
          ...
          <div class="col-quick-action">
          <?php
    $offset = 4; // Number of rows to skip (starting from row 1)

    $sel = mysqli_query($conn, "SELECT * FROM bloodGroup LIMIT 4 OFFSET $offset");
...
?>
      ...
      <div class="col-side-one-item item-quick-action" style="box-shadow: none;overflow-y: hidden;">
        ...
        <div class="col-quick-action">
        <?php
	$sel=mysqli_query($conn,"select * FROM bloodGroup");
	while($row=mysqli_fetch_assoc($sel))
   ...
   if (!empty($iconImage)) {
    ...
    $imageUrl = "../img/menu-icon/default.png";
		...
		?> 
          <div class="col-quick-action-details">
          <a href="donor.php<?php echo"?id=".$id." & bloodID=".$bloodID."";?>">
              <div class="col-quick-icon">
                <center>
                  <img src="<?php echo $imageUrl;?>" alt="">
                </center>
