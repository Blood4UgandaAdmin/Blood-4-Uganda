...
<div class="home">
  <div class="col-topbar nav-mobile hide-desktop">
    <div class="topnav">
      <a href="#news" class="hide-app">Donors Information</a>
     ...
     <span class="topDetails">Donors Information</span> 
      </a>
  ...
  <section >
    <div class="col-topbar show-tab-topbar">
      ...
      <a href="index.php<?php echo"?id=".$id."";?>" class="topAction-mobile">
        ...
        <a href="#news" >Donors Information</a>
...
?>
  ...
  $bloodID = $_GET['bloodID'];
	$sel=mysqli_query($conn,"select * FROM donors INNER JOIN users ON users.userID = donors.donorID INNER JOIN bloodGroup ON donors.bloodGroup = bloodGroup.bloodID WHERE bloodID = '".$bloodID."'");
	while($row=mysqli_fetch_assoc($sel))
   ...
   if (!empty($profileImage)) {
    ...
    $imageUrl = "../img/uploads/user2.png";
      ...
      <div class="col-side-two hide-desktop show-table " style="margin-left: 0;height:80vh">
      <div class="col-side-one-item item-three" style="padding: 10px;height:80vh;overflow-x:auto">
    ...
    <?php
	$sel=mysqli_query($conn,"select * FROM donors INNER JOIN users ON users.userID = donors.donorID");
	// Check for query success and handle errors
if (!$sel) {
  die("Query failed: " . mysqli_error($conn));
}
