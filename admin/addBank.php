  ...
  <section >
    <div class="col-topbar show-tab">
      <div class="topnav">
       ...
       <span class="topDetails">New Blood Bank</span> 
        </a>
      </div>
  ...
  <section>
    <div class="col-body ">
      <div class="col-table">
        ...
        <form id="regForm" action="../include/newBloodBank.php<?php echo "?id=".$id."";?>" method="POST">
              <div class="column one">
                <h4>facility Info:</h4>
                  <div class="field username">
                      <label for="Username_">Full Name</label>
                  ...
                  <div class="field phone">
                    ...
                    <div class="phone-con" >
                      <div class="phone-code" style="margin-top: -20px;">
                      ...
                      <div class="phone-number" style="margin-top: -20px;">
