...
<div class="home">
  <div class="col-topbar nav-mobile hide-desktop">
    <div class="topnav">
      ...
      <a href="#news" class="topAction-mobile">
     <span class="topDetails">volunteers Information</span> 
      </a>
    </div>
    ...
    <div class="col-body">
      <div class="col-table hide-app">
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
          <?php
	$sel=mysqli_query($conn,"select * FROM volunteer INNER JOIN users ON users.userID = volunteer.VID");
...
<div id="myModal" class="modal model-table">
 ...
 <!--FABS-->
 <div class="fabs">
  <a href="addVolunteer.php<?php echo"?id=".$id."";?>">
