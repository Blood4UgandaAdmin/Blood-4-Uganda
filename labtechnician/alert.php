  ...
  <section >
    <div class="col-topbar show-tab">
      <div class="topnav">
       ...
       <span class="topDetails">New Alert</span> 
        </a>
      </div>
  ...
  <section>
    <div class="col-body ">
      <div class="col-table">
        ...
        <form id="regForm"  action="../include/newAlertDonor.php<?php echo "?id=".$id."";?>" method="POST">
              <div class="column one">
                <h4>Alert Info:</h4>
                  
                  <div class="field email">
                      <label for="Email_">Blood Bank</label><br>
          ...
          <option value="None">None</option>
                  ...
                  <div class="field email">
                      <label for="Email_">Facilities</label><br>
                  ...
                  <?php
						...
						while($row = mysqli_fetch_array($result)){
							...
							echo "<option value=\"$FID\" class=\"mail-user\">".$name."</option>";
          ...
          <option value="None">None</option>
              ...
              <div class="column two">
                ...
                <div class="field phone">
                    ...
                    <select id="inputState" name="alertType" class="form-control">
            <option value='Emergency'>Blood Selling</option>
            <option value='Routine'>Others</option>
            </select>
             ...
             <label for="Phone_">Any Comment</label>
